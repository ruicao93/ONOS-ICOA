 ...
 */
public abstract class IPAddress<F extends IPAddress<F>> implements OXPValueType<F> {
     ...
     */
    public abstract IPAddressWithMask<F> withMask(final F mask);
     ...
     */
    @Deprecated
    public static IPAddress<?> fromInetAddress(InetAddress address) {
        return of(address);
    }
}
