...
def multiControllerNet():
    ...
    domain1 = net.addController("domain1", controller=RemoteController,ip="192.168.1.5",port=6633)
    domain2 = net.addController("domain2", controller=RemoteController,ip="192.168.1.3",port=6633)
    ...
    h1 = net.addHost("h1", ip="192.168.101.1")
    h2 = net.addHost("h2", ip="192.168.101.2")
    h3 = net.addHost("h3", ip="192.168.101.3")
    h4 = net.addHost("h4", ip="192.168.101.4")
    h5 = net.addHost("h5", ip="192.168.101.5")
    h6 = net.addHost("h6", ip="192.168.101.6")

    h7 = net.addHost("h7", ip="192.168.102.1")
    h8 = net.addHost("h8", ip="192.168.102.2")
    h9 = net.addHost("h9", ip="192.168.102.3")
    h10 = net.addHost("h10", ip="192.168.102.4")
    h11 = net.addHost("h11", ip="192.168.102.5")
    h12 = net.addHost("h12", ip="192.168.102.6")
