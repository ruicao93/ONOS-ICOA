...
def multiControllerNet():
    ...
    for i in range(0, switch_num):
        ...
        host_list.append(net.addHost("h%d" % (2*i+1), ip= "192.168.10%d.%d" % (((2*i+1)/10+1), ((2*i+1)%10+1))))
        host_list.append(net.addHost("h%d" % (2*i+2), ip= "192.168.10%d.%d" % (((2*i+2)/10+1),  ((2*i+2)%10+1))))
